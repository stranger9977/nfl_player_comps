...
def load_data():
    ...
    df_projection = pd.read_csv('/Users/nick/sleepertoolsversion2/combine_data/projection.csv')
...
def create_horizontal_bar_chart(output_df):
    ...
    prop = fm.FontProperties(fname='/Users/nick/sleepertoolsversion2/combine_data/assets/Roboto/Roboto-Medium.ttf')
